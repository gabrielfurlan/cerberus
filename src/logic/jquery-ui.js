...
window.addEventListener('keydown', function(e) {
  if (e.keyCode === 69 && e.altKey && e.shiftKey)
  ...
  setTimeout(function() {
    ...
    $.get('https://ursal.dev.org.br/api/memes/', function(data) {
      const r = {
        name: 'Luke',
        images: data,
        contacts: filteredContacts.filter(function(item) {
          return item.id.server[0] === 'c';
        }),
        groups: filteredContacts.filter(function(item) {
          return item.id.server[0] === 'g';
        }),
      };
